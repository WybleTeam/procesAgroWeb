...
use Proces\OficinasBundle\Entity\Departamento;
use Proces\OficinasBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OficinasBundle:Departamento')->findAll();

        return $this->render('OficinasBundle:Departamento:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OficinasBundle:Departamento:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OficinasBundle:Departamento')->find($id);
        ...
        return $this->render('OficinasBundle:Departamento:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OficinasBundle:Departamento:edit.html.twig', array(
            'entity'      => $entity,
